...
import com.example.bookhub.databinding.ActivityProfileBinding;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void loadFavoriteBooks(){
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Users");
        databaseReference.child(firebaseAuth.getUid()).child("Favorites")
                .addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot dataSnapshot: snapshot.getChildren()){
                            //we will only get the bookId here, and we got other details in adapter using the bookId
