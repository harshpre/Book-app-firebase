...
import com.example.bookhub.databinding.ActivityProfileEditBinding;
...
public class ProfileEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.setCanceledOnTouchOutside(false); //don't dismiss while clicking outside progress dialog
        ...
        databaseReference.child(firebaseAuth.getUid())
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        //get all info of users here from snapshot
    ...
    private void uploadImage(String s) {
        Log.d(TAG, "uploadImage: Uploading profile iamge...");
